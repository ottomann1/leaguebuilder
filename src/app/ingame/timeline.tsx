...
export function Timeline({ eventData }: TimelineProps) {
  ...
  return (
    <div className="overflow-y-auto w-[15vw] h-[42vh] bg-base-100">
      <h2 className="card-title text-center p-0 pl-4 pt-4">Event Timeline</h2>
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        {filteredEvents.map((event) => (
          <li key={event.EventID}>
            <div className="timeline-middle">
              <div className="card bg-base-300 p-2 rounded-lg mb-5">
                <time className="">{formatTime(event.EventTime)}</time>
